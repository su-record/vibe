...
### REQ-system-lean-hardening-001: A. 깨진 배선 수리 (P1)
...
### REQ-system-lean-hardening-002: B. 죽은 자산 제거 (P1)
...
### REQ-system-lean-hardening-003: C. 핫패스 최적화 (P2)
...
### REQ-system-lean-hardening-004: D. 중복 통합 (P2)
...
### REQ-system-lean-hardening-005: E. 컨텍스트 다이어트 (P2)
...
### REQ-system-lean-hardening-006: F. 재발 방지 고도화
