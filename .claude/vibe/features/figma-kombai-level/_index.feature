# Feature: figma-kombai-level (Master)

**Master SPEC**: `.claude/vibe/specs/figma-kombai-level/_index.md`
...
## Overall User Story
**As a** vibe.figma 사용자
**I want** Figma 디자인을 Kombai 수준의 품질로 코드 변환
**So that** 컴포넌트 재사용, 컴파일 안정성, 토큰 일관성, 멀티 페이지 효율이 보장됨
