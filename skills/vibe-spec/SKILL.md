...
**🚨 CRITICAL: Files MUST be created in these EXACT paths.**

See `reference/output-paths.md` for the full path contract (small vs large scope, forbidden/required rules, file creation templates).

## Example

See `reference/example-walkthrough.md` for an end-to-end conversational walkthrough.

## Core Tools

See `reference/tools-guide.md` for semantic-analysis/memory tool invocation patterns and recommended tools during SPEC creation.
