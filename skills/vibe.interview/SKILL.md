...
| `interview/*`, `feature/*` | 사용자 확인 |
| 기타 | 사용자 확인 |

**네이밍**: 소문자 + 하이픈, 접두사 `interview/`
...
**출력 파일**: `.claude/vibe/interviews/{feature-name}.md`
...
Claude: 🌿 브랜치 생성: interview/parallax-website ✅
...
- **Next**: `vibe.plan` — interview 결과를 기획서로 정제
