// Get session context for automatic context injection
// This tool aggregates memories, knowledge graph, and timeline for session start

import { ToolResult, ToolDefinition, MemoryRelation } from '../../infra/types/tool.js';
import { MemoryManager, MemoryItem } from '../../infra/lib/MemoryManager.js';
...
function groupByDate(memories: MemoryItem[]): Record<string, MemoryItem[]> {
...
function summarizeRelations(edges: MemoryRelation[]): string {
