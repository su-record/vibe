...
export async function analyzeComplexity(args: { code?: string; metrics?: string; targetPath?: string; projectPath?: string }): Promise<ToolResult> {
  ...
  interface ComplexityMetricResult {
    value: number | null;
    threshold?: number;
    status: string;
    description: string;
  ...
  interface ComplexityResults {
    astCyclomaticComplexity?: ComplexityMetricResult;
    cyclomaticComplexity?: ComplexityMetricResult;
    cognitiveComplexity?: ComplexityMetricResult;
