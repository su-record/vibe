...
export function cleanupOptionalSkills(
  ...
  shippedSkillsDir: string | string[],
  dryRun = false,
): OptionalSkillResult[] {
 ...
 */
export function resolveSkillRoots(packageRoot: string): string[] {
  return SKILL_ROOTS
