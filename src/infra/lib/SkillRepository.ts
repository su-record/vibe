 ...
 */
/**
 * Generate DEFAULT_SKILLS with resolved core path URL.
 * Accepts corePathUrl as parameter to avoid infra→cli layer violation.
 */
export function getDefaultSkills(corePathUrl: string): Array<{ id: string; content: string }> {
  return [
    {
...
/** @deprecated Use getDefaultSkills(corePathUrl) instead */
export const DEFAULT_SKILLS: Array<{ id: string; content: string }> = getDefaultSkills('');
