...
export function mcpbManifest(version: string, description: string): Record<string, unknown> {
  return {
    ...
    version,
    description,
    long_description: 'Your personal FDE in the Claude desktop app: context, internal guidance, skill extensions and recorded verification in your selected project. Building the code stays with Claude Code, Codex or Hermes; they share the same .vibe/ state. Needs the vibe CLI: npm i -g @su-record/vibe.',
    ...
    tools: [{ name: 'vibe', description: 'Your personal FDE: context, guidance and discoverable internal operations' }],
