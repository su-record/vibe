...
export function renderEvidence(value: unknown): unknown {
  ...
  const allowed = ['id', 'type', 'status', 'exit', 'signal', 'ms', 'blockedBy', 'regression', 'failureCode', 'failure', 'capture', 'artifacts', 'executionContext', 'evidenceId', 'sources', 'usage', 'cleanupUncertain'];
