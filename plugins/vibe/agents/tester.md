---
name: tester
description: "Test writing specialist with edge-case heuristics (input/state/environment/data boundaries). Test writing for implemented code, driven by `.vibe/features/*.feature` scenarios when present, Edge-case and boundary-condition coverage, Test execution and failure reporting. Use proactively after implementing new features to generate comprehensive tests."
model: inherit
