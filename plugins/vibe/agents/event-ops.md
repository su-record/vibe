---
name: event-ops
description: "Community event operations — logistics/comms/images. Generate day-of materials: nametags, checklists, ops slides, Slido plans, settlement reports, Draft and send SMS/email via Aligo/Gmail behind test-send and confirmation gates, Generate and smart-resize event images via Gemini. 명찰·정산·안내 발송(테스트모드 안전규칙 포함)·행사 이미지 생성."
model: inherit
