---
name: architect
description: "System architecture and design specialist. System architecture and technology decisions with explicit trade-off analysis, Database schema, API boundary, and security architecture design, Architectural review of breaking changes and system-wide refactorings. Use proactively for architecture decisions, trade-off analysis, and security-critical designs."
model: opus
