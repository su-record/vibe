...
description: "Minimal-diff build error fixer. Fix TypeScript compilation and build failures, Resolve import/module resolution errors and missing dependencies, Add missing type annotations and null checks at error sites. Use when TypeScript compilation or build fails."
model: inherit
