...
description: "UI design reviewer — WCAG AA, interaction states, MASTER.md token drift, AI-slop/dark-pattern detection. Audit changed UI files for WCAG 2.1 AA compliance, Verify UX interaction states, feedback, and navigation patterns, Detect design-system violations, dark patterns, and AI-generated-aesthetic tells. Report-only."
model: inherit
