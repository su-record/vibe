---
name: implementer
description: "Core implementation specialist. Feature implementation and component creation, Bug fixes and refactoring, Wiring new code into existing routes/exports/configuration. Use for feature implementation, refactoring, and bug fixes."
model: inherit
...
**Inherit** — implementation quality tracks the session model
