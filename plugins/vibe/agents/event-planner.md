---
name: event-planner
description: "Community event planner — schedule/speaker/content. Calculate D-Day, determine current phase, and orchestrate the task timeline, Research speakers, check topic overlap, and draft outreach, Generate intro pages, SNS posts, and post-event reviews in community tone. D-Day 체크리스트, Notion DB, 연사 스펙, 홍보 콘텐츠 생성."
model: inherit
