 ...
 */
export type SearchDomain = 'style' | 'color' | 'chart' | 'landing' | 'product' | 'ux' | 'typography' | 'icons' | 'react' | 'web' | 'prompt' | 'ui-reasoning';
export type StackName = 'nextjs' | 'react' | 'shadcn' | 'html-tailwind' | 'svelte' | 'vue' | 'nuxtjs' | 'nuxt-ui' | 'astro' | 'flutter' | 'react-native' | 'swiftui' | 'jetpack-compose';
...
export type CsvRow = ProductRow | UiReasoningRow | StyleRow | ColorRow | TypographyRow | LandingRow | ChartRow | IconRow | ReactPerfRow | UxGuidelineRow | WebInterfaceRow | StackGuidelineRow;
