 ...
 */
import { DEFAULT_EMBEDDING_DIMENSIONS, EMBEDDING_API_TIMEOUT_MS, GPT_EMBEDDING_BASE_URL, GPT_EMBEDDING_MODEL, } from './types.js';
...
export class EmbeddingProvider {
    ...
    async embed(texts) {
        ...
        if (!this.isAvailable()) {
            throw new Error('All embedding providers failed: OPENAI_API_KEY not set');
        }
        return this.callGptEmbedding(texts);
    }
    async callGptEmbedding(texts) {
