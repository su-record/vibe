...
export class EvolutionOrchestrator {
     ...
     */
    generate() {
        const result = { generated: [], rejected: [], errors: [] };
        const actionable = this.insightStore.getActionable();
        let count = 0;
        for (const insight of actionable) {
            if (count >= this.config.maxGenerationsPerCycle)
                break;
            try {
    ...
    saveGeneration(insight, type, name, content, triggerPatterns) {
        // Validate filename
     ...
     */
    cleanupTempFiles() {
        for (const type of ['skill', 'agent', 'rule']) {
...
//# sourceMappingURL=EvolutionOrchestrator.js.map