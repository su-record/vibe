...
export class DeprecationDetector {
     ...
     */
    getEvaluatedSkills() {
        const rows = this.db.prepare('SELECT DISTINCT skillName FROM skill_eval_cases ORDER BY skillName ASC').all();
     ...
     */
    determineSeverity(classification, benchmark) {
...
function buildSoonReason(blRate, category, trend) {
...
//# sourceMappingURL=DeprecationDetector.js.map