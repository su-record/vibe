...
export function projectVibeRoot(projectDir) {
    try {
...
/** 읽기용 경로 — 레거시 인식 */
export function projectVibePath(projectDir, ...sub) {
    return path.join(projectVibeRoot(projectDir), ...sub);
}
/** 쓰기용 경로 — 항상 신규 레이아웃(`.vibe/`) */
export function projectVibePathPreferred(projectDir, ...sub) {
    return path.join(projectDir, '.vibe', ...sub);
}
//# sourceMappingURL=vibePaths.js.map