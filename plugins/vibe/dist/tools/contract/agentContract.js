 ...
 */
export function parseAgentContract(specContent) {
...
function violationOf(call, index, contract) {
 ...
 */
export function checkAgentToolLog(contract, log) {
    const advisory = contract.escalations.map((condition) => `에스컬레이션 조건은 도구 로그로 판정할 수 없다 — 사람이 확인한다: ${condition}`);
    if (!log) {
...
//# sourceMappingURL=agentContract.js.map