...
// ============================================================================
export const reflectNowDefinition = {
...
export async function reflectNow(args) {
    try {
...
// ============================================================================
export const searchReflectionsDefinition = {
...
export async function searchReflections(args) {
    try {
        const mm = MemoryManager.getInstance(args.projectPath);
        const store = mm.getReflectionStore();
...
// ============================================================================
export const getSessionReflectionsDefinition = {
...
export async function getSessionReflections(args) {
    try {
        const mm = MemoryManager.getInstance(args.projectPath);
        const store = mm.getReflectionStore();
...
//# sourceMappingURL=reflectionTools.js.map