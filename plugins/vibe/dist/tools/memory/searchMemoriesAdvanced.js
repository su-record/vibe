// Advanced multi-strategy memory search
...
export async function searchMemoriesAdvanced(args) {
    try {
        const { query, strategy = 'context_aware', limit = 10, category, startKey, depth = 2, includeRelations = false, projectPath } = args;
...
//# sourceMappingURL=searchMemoriesAdvanced.js.map