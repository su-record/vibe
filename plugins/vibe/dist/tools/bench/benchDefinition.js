...
function checkArms(arms, findings) {
...
function checkTaskSet(taskSet, findings) {
...
export function validateBenchDefinition(definition) {
    const findings = [];
...
//# sourceMappingURL=benchDefinition.js.map