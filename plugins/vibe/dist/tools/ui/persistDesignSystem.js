...
export const persistDesignSystemDefinition = {
    name: 'core_ui_persist_design_system',
    description: 'save design system|persist design|write design system - Generate and persist design system as MASTER.md and optional page-specific overrides to project directory',
    inputSchema: {
        type: 'object',
        properties: {
            query: {
            ...
            page: {
                type: 'string',
                description: 'Optional page name for page-specific overrides (e.g., "landing", "dashboard")',
            },
        },
...
//# sourceMappingURL=persistDesignSystem.js.map