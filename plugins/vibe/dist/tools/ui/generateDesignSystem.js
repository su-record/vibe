...
export const generateDesignSystemDefinition = {
    name: 'core_ui_generate_design_system',
    description: 'generate design system|create design|build design system - Generate a complete design system from product description using 5-stage pipeline (Category Detection → Reasoning → Style/Color/Typography/Layout Search → Best Match → CSS Variables)',
    inputSchema: {
        type: 'object',
        properties: {
            query: {
                type: 'string',
                description: 'Product description (e.g., "SaaS dashboard for fintech", "E-commerce landing page")',
            },
            projectName: {
                type: 'string',
...
//# sourceMappingURL=generateDesignSystem.js.map