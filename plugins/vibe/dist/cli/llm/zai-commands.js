...
export function setZaiKey(apiKey) {
    patchGlobalConfig({
...
export function setZaiCodingKey(apiKey) {
    patchGlobalConfig({
        credentials: { zai: { codingApiKey: apiKey, createdAt: new Date().toISOString() } },
    });
    console.log(`ZAI Coding Plan key configured.\n` +
        `Stored: ${getVibeDir()}/config.json\n` +
        `GLM(최고 모델)이 UI 개발을 담당합니다.`);
}
export function zaiStatus() {
...
//# sourceMappingURL=zai-commands.js.map