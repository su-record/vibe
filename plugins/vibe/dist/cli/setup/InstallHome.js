...
/** 플랫폼 관례상의 홈 경로 */
function conventionalHome(user) {
...
export function resolveInstallHome() {
    const fallback = { home: os.homedir(), redirected: false };
 ...
 */
export function restoreOwnership(target, info) {
    if (!info.redirected || info.uid === undefined || info.gid === undefined)
        return false;
...
//# sourceMappingURL=InstallHome.js.map