...
import { compatibility } from '../bench/fde/readiness.js';
...
} catch (error) { console.error(JSON.stringify({ errorCode: 'CHECK_TRUST_COMPATIBILITY_FAILED', details: contentSummary(error.message) })); process.exitCode = 1; }
