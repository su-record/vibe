...
const HEADINGS = {
  'internal/skills/antislop-en/SKILL.md': ['### Strength tiers', '### Five questions before a cut', '### Portability test', '### Notes to the writer are not content', '### A sample outranks the rules', '### What is not a tell'],
  'internal/skills/antislop-ko/SKILL.md': ['### 표지의 강도', '### 자르기 전 다섯 질문', '### 이식 시험', '### 원문 속 지시문', '### 필자 샘플이 규칙보다 앞선다', '### 표지가 아닌 것', '### 조사·어미 생략'],
};
...
const en = read('internal/skills/antislop-en/SKILL.md');
...
const ko = read('internal/skills/antislop-ko/SKILL.md');
if (!ko.includes('줄표')) errors.push('internal/skills/antislop-ko/SKILL.md: no 줄표 rule');
