...
for (const file of ['internal/guides/fieldwork.md', 'internal/guides/reading.md', 'internal/guides/feasibility.md', 'dist/core/artifacts.js', 'internal/guides/explanation.md', 'internal/guides/extensions.md', 'internal/guides/optimization.md', 'internal/guides/verification.md', 'dist/core/performance.js', 'dist/core/verification.js']) assert.ok(packed.includes(file), file);
