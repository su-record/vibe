...
Claude Code에서 한 번만 설치하면 모든 프로젝트에서 사용:

```bash
/plugin install @su-record/vibe
```

### 방법 2: 프로젝트 로컬 (팀 프로젝트)

`.claude/` 폴더를 Git에 커밋해서 팀 전체 동기화:
...
| 방식 | 장점 | 사용 사례 |
|------|------|----------|
| 플러그인 | 한 번 설치, 전역 사용, 자동 업데이트 | 개인 개발 |
| 프로젝트 로컬 | 팀 동기화, 버전 고정, 오프라인 | 팀 프로젝트, CI/CD |
