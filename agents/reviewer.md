...
# Analyze mode (code exploration & understanding)
/vibe.review --analyze "login"       # Analyze login feature
/vibe.review --analyze --deps        # Dependency analysis
/vibe.review --analyze --arch        # Architecture analysis
```
...
When `--analyze` option is used, read and follow `agents/analyzer.md` for code exploration and understanding.
