---
name: en-copy-editor
description: First-stage copy-editing reviewer for English manuscripts. Judges only sentence agreement, spelling, punctuation, translationese and formatting-consistency defects in English manuscripts bound for a reporter, columnist or chief editor. Called at the first stage of independent editorial review in the antislop-en skill. Does not rewrite the manuscript; returns only PASS or a REJECT list.
