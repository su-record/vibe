# Discover the useful intervention

Understand the user's work, desired outcome, friction and constraints from accessible documents, samples and prior decisions. Ask only when an answer changes the problem, success condition or authority. A clear request needs no ceremonial interview.
