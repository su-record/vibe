...
Use the fieldwork guide when local success differs from actual use or a workaround recurs. Retain the remaining target-environment observation, apply confirmed corrections to future behavior, and distinguish temporary fixes from justified reusable capabilities.
